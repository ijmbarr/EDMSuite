namespace NationalInstruments.ModularInstruments.Interop
{
	...
	/// function.
        ...
        {
            int pInvokeResult = PInvoke.WriteNamedWaveformFromFileHWS(this._handle, Waveform_Name, File_Path, (ushort)System.Convert.ToUInt16(Use_Rate_From_Waveform), out Waveform_Size);
